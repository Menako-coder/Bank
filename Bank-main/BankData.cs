    ...
    public abstract class BankData : IPrint
    {
        ...
        public int AccountNumber
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new InvalidOperationException("Your account number should contains 4 symbols");
                }
                accountNumber = value;
            }
        }
        ...
        public decimal MoneyAvailable
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new InvalidOperationException("You can not have 0 or less money in your account");
                }
